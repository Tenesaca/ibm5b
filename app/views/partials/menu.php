<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
    <div class="container">
        <a class="navbar-brand" href="/sexo/ibm5b/public">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/sexo/ibm5b/public/persona">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="/sexo/ibm5b/public/sexo">
                                <i class="fas fa-venus-mars me-1"></i> Sexos
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/sexo/ibm5b/public/estado-civil">
            ...
            <form class="d-flex" action="/sexo/ibm5b/public/persona" method="GET">
