...
// Corregir la ruta y nombre de la clase
require_once $_SERVER['DOCUMENT_ROOT'] . '/ibm5b/config/database.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/ibm5b/app/models/EstadoCivilModel.php'; // Ruta corregida
...
class estadocivilController {
    ...
    public function __construct() {
        ...
        $this->estadocivil = new EstadoCivilModel($this->db); // Nombre de clase corregido
    }
